...
test("catálogo de runners: 9 runners, valores únicos, incluindo grok-custom, qwen e dsh", () => {
  assert.equal(node.RUNNER_CATALOG.length, 9);
  ...
  assert.ok(values.includes("dsh"), "dsh esquecido?");
